...
{ 
    ...
    $query="insert into registration(name,password,age,contact_no,photo,type) values('$name','$pass','$age','$cno','$newfilename','customer')";
...
<nav class="navbar navbar-expand-lg bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><b style="color:aliceblue ;">ELECTRONIC ITEM REPAIRE</b></a>
